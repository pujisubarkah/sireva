...
<LayoutShell>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <StatCard title="SASARAN STRATEGIS" value="1 SS" badgeText="Tercapai" variant="green" />
        <StatCard title="SASARAN PROGRAM" value="3 SP" badgeText="Berjalan" variant="blue" />
        <StatCard title="SASARAN KEGIATAN" value="8 SK" badgeText="Aktif" variant="blue" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <InfoCard title="VISI & TUJUAN" accent="blue" actionLabel="Lihat Detail">
        ...
        <InfoCard title="STATUS CASCADING" accent="green" actionLabel="Lihat Pohon">
        ...
        <InfoCard title="STATUS KINERJA" accent="green">
