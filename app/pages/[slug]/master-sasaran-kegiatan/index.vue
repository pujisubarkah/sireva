      ...
      >
        ...
        <template #cell-aksi="{ row }">
          <div class="flex items-center justify-center gap-1">
            <NuxtLink
              :to="`/${route.params.slug}/master-sasaran-kegiatan/view?id=${row.skId}${row.id !== row.skId ? '&indId=' + row.id : ''}`"
            ...
            <NuxtLink
              :to="`/${route.params.slug}/master-sasaran-kegiatan/edit?id=${row.skId}${row.id !== row.skId ? '&indId=' + row.id : ''}`"
