  ...
  <div class="space-y-6 max-w-5xl mx-auto pb-10">
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div class="px-6 py-5 border-b border-slate-200 bg-slate-50">
        ...
        <p class="text-sm text-slate-500 mt-1">Kelola dan evaluasi laporan capaian indikator pada perjanjian kinerja.</p>
      </div>
            ...
            <form id="laporan-form" @submit.prevent="handleSubmit" class="space-y-8 pb-10">
              ...
              <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-5 p-5 bg-slate-50 rounded-xl border border-slate-100">
                  <div class="space-y-2">
                    <label class="block text-sm font-medium text-slate-700">Sasaran Strategis <span class="text-red-500">*</span></label>
              ...
              <div class="space-y-4">
                ...
                <div class="space-y-6">
                  ...
                  <div class="space-y-2 p-5 bg-emerald-50/70 rounded-xl border border-emerald-100">
                    <label class="flex items-center gap-2 text-sm font-medium text-emerald-900 mb-3">
                    ...
                    <textarea 
                      ...
                      rows="3" 
                      class="field-input resize-y bg-white border-emerald-200 focus:border-emerald-500 focus:ring-emerald-500/20" 
          ...
          <div class="flex-1 overflow-y-auto p-4 sm:p-8 bg-slate-100">
            <div class="bg-white max-w-3xl mx-auto shadow-sm border border-slate-200 rounded-lg p-8 sm:p-12">
              ...
              <div class="text-center pb-8 border-b-2 border-slate-800 mb-8">
                <h1 class="text-2xl font-black text-slate-900 uppercase tracking-tight">Laporan Capaian Kinerja</h1>
              ...
              <div class="space-y-8 text-slate-800">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div class="text-sm font-bold text-slate-500 uppercase tracking-wider">Sasaran Strategis</div>
                  <div class="md:col-span-3 font-medium text-lg leading-relaxed">{{ getSasaranNameByIndikator(viewingLaporan.indikatorId) }}</div>
                </div>
                
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div class="text-sm font-bold text-slate-500 uppercase tracking-wider">Indikator Kinerja</div>
                  <div class="md:col-span-3 font-bold text-xl text-[#2663A3] leading-relaxed">{{ getIndikatorName(viewingLaporan.indikatorId) }}</div>
                </div>
...
const filteredLaporanList = computed(() => {
  ...
  if (searchQuery.value) {
    ...
    list = list.filter((l: any) => {
      const sasaran = getSasaranNameByIndikator(l.indikatorId).toLowerCase();
      const indikator = getIndikatorName(l.indikatorId).toLowerCase();
      return sasaran.includes(q) || indikator.includes(q);
    });
  }
...
.field-input:focus {
  outline: none;
  border-color: #2663A3;
  box-shadow: 0 0 0 3px rgba(38, 99, 163, 0.15);
}
