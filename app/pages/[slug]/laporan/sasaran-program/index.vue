      ...
      <div class="p-6 sm:p-8">
        ...
        <div v-else class="overflow-x-auto border border-slate-200 rounded-xl">
          ...
          >
            ...
            <template #cell-sasaranProgramName="{ row }">
              <div class="line-clamp-2 font-semibold text-slate-800" :title="getSasaranName(row.sasaranProgramId)">
                {{ getSasaranName(row.sasaranProgramId) }}
              </div>
            </template>
...
const tableColumns = [
  ...
  { key: 'sasaranProgramName', label: 'Sasaran Program', width: 280 },
