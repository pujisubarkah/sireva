          ...
          <table class="w-full text-left border-collapse">
            <thead>
              <tr class="bg-slate-50 border-b border-slate-200 text-xs uppercase tracking-wider text-slate-500 font-bold">
                ...
                <th class="p-4 min-w-[200px]">Indikator Kinerja</th>
                <th class="p-4 min-w-[250px]">Rencana Aksi</th>
            ...
            <tbody class="divide-y divide-slate-100 text-sm text-slate-700">
              <tr v-for="laporan in filteredLaporanList" :key="laporan.id" class="hover:bg-slate-50 transition-colors">
                ...
                <td class="p-4 text-xs text-slate-600">
                  <div class="line-clamp-2" :title="getIndikatorNameByRencanaAksi(laporan.rencanaAksiId)">
                    {{ getIndikatorNameByRencanaAksi(laporan.rencanaAksiId) }}
                  </div>
                </td>
                <td class="p-4 font-semibold text-slate-800">
                  <div class="line-clamp-2" :title="getRencanaAksiName(laporan.rencanaAksiId)">
                    {{ getRencanaAksiName(laporan.rencanaAksiId) }}
                  </div>
                </td>
