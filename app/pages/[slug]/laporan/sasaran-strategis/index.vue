  ...
  <div class="space-y-6 max-w-4xl mx-auto pb-10">
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div class="px-6 py-5 border-b border-slate-200 bg-slate-50">
        ...
        <p class="text-sm text-slate-500 mt-1">Form pelaporan untuk analisa capaian indikator sasaran strategis.</p>
      </div>
        ...
        <div v-else-if="!laporanList || laporanList.length === 0" class="min-h-[50vh] flex flex-col items-center justify-center bg-white py-10 px-4">
          <div class="bg-white shadow-2xl rounded-3xl p-10 max-w-2xl w-full text-center border border-blue-100 relative overflow-hidden">
            <div class="flex flex-col items-center mb-6">
              ...
              <p class="text-lg md:text-xl text-gray-700 font-semibold mb-2">Belum ada laporan <span class="text-[#F2BD1D]">sasaran strategis</span></p>
            </div>
          ...
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-slate-100 text-sm text-slate-700">
              <tr v-for="laporan in laporanList" :key="laporan.id" class="hover:bg-slate-50">
                ...
                <td class="p-4 text-xs text-slate-600 max-w-[200px] truncate" :title="getSasaranName(laporan.sasaranId)">{{ getSasaranName(laporan.sasaranId) }}</td>
