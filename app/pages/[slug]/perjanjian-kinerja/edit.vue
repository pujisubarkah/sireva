  ...
  <div class="space-y-6">
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
        <div>
          <h1 class="text-lg font-semibold text-slate-800">Edit Perjanjian Kinerja</h1>
...
onMounted(async () => {
  ...
  try {
    ...
    // In a real app, you would fetch this from /api/perjanjian-kinerja?id=...
    form.value = {
      id: id,
      sasaran: 'Sasaran Ke-' + id + ' yang sudah ada',
      indikator: 'Indikator Ke-' + id + ' yang sudah ada',
