...
const baseData = [
  { id: 1, sasaran: 'Terwujudnya ASN yang Profesional dan Kompeten', indikator: 'Indeks Kepuasan Peserta Pelatihan', target: 85.0 },
  { id: 2, sasaran: 'Meningkatnya Kualitas Kurikulum Kediklatan ASN', indikator: 'Jumlah Modul Pelatihan Kepemimpinan Tersusun', target: 4 },
  { id: 3, sasaran: 'Terintegrasinya Sistem Pembelajaran Digital LAN', indikator: 'Jumlah Fitur Platform Pembelajaran Aktif', target: 3 },
];
